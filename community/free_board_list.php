                ...
                <div class="col-3">
                    <nav id="lnb">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="/community/free_board_list.php">자유게시판</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-9">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>123</td>
                                            <td class="subject">
                                                <a href="#">김진별 님의 상담문의입니다.김진별 님의 상담문의입니다.김진별 님의 상담문의입니다.김진별 님의 상담문의입니다.김진별 님의 상담문의입니다.</a>
                                            </td>
                                            <td>작성자</td>
                                            <td>2018-10-10</td>
                                        </tr>
