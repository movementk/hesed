                ...
                <div class="col-9">
                    <section class="inquiry-list">
                        ...
                        <div class="section-content">
                            <div class="table-wrap board-table">
                                <table class="table">
                                    <colgroup>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>123</td>
                                            <td class="subject">
                                                <a href="/community/inquiry_view.php">김진별 님의 상담문의입니다.김진별 님의 상담문의입니다.김진별 님의 상담문의입니다.김진별 님의 상담문의입니다.김진별 님의 상담문의입니다.</a>
                                            </td>
                                            <td>2018-10-10</td>
                                            <td class="situation">
                                                <p>답변대기</p>
                                        ...
                                        <tr>
                                            <td>123</td>
                                            <td class="subject">
                                                <a href="/community/inquiry_view.php">김진별 님의 상담문의입니다.</a>
                                            </td>
                                            <td>2018-10-10</td>
                                            <td class="situation">
                                                <p>답변대기</p>
